...
Editors (`nano`, `vim`, Emacs) and writing shell scripts. This topic includes the **advanced** scripting lab.

| | |
| --- | --- |
| **Slides** | [`slides/text-editing-and-shell-scripting.pdf`](slides/text-editing-and-shell-scripting.pdf) |
